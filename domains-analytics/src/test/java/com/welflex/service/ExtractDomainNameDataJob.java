...
public class ExtractDomainNameDataJob extends Configured {

  static final String KEYSPACE = "DomainNamesData";

  static final String COLUMN_FAMILY = "domains";

  static final String OUTPUT_COLUMN_FAMILY = "output_domains";
  private final String[] expectedDomains;
  
  public ExtractDomainNameDataJob(String... expectedDomains) {
  ...
  public static class TokenizerMapper extends
    ...
    private Set<String> expectedDomains;
    ...
    protected void setup(@SuppressWarnings("rawtypes") org.apache.hadoop.mapreduce.Mapper.Context context) throws IOException,
      ...
      String[] expWords = context.getConfiguration().getStrings("expectedDomains");
      expectedDomains = new HashSet<String>(Arrays.asList(expWords));
    }
    ...
    public void map(ByteBuffer key, SortedMap<ByteBuffer, IColumn> columns, Context context) throws IOException,
      ...
      for (Map.Entry<ByteBuffer, IColumn> entry : columns.entrySet()) {
        ...
        while (itr.hasMoreTokens()) {
          ...
          if (expectedDomains.contains(nextWord)) {
            word.set(nextWord);
  ...
  public void run() throws IOException, InterruptedException, ClassNotFoundException {
    ...
    getConf().setStrings("expectedDomains", expectedDomains);
    ...
    for (Map.Entry<UUID, UUID> entry : keyRangeMap.entrySet()) {
      ...
      job.setJarByClass(ExtractDomainNameDataJob.class);
