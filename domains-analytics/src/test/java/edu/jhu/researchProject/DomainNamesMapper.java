...
import edu.jhu.researchProject.ExtractFromCompressedData.MyCounter;

public class DomainNamesMapper extends
...
if (arr.length == 3) {
	...
	try {
		String content = getHtmlUnitDomainNamesProcessor().getWebPageContent("http://"+domainName.substring(domainName.indexOf(".")+1)+".com");
